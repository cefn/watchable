 ...
 * {@link @watchable/store.Immutable} state to reflect your drafted changes, leaving the old state
 ...
 *
 * @param draft A mutable proxy of a {@link @watchable/store.Store}'s existing `Immutable` state.
